  ...
  return (
    <div id="Contact" className="p-4 lg:p-10 flex flex-col items-center justify-center">
      ...
      <form  className="flex flex-col gap-2 lg:w-1/2" ref={form} onSubmit={sendEmail}  >
        ...
        <textarea name='message' cols="20" rows="10" className="w-full my-3 rounded-lg bg-slate-800 p-4 border-2 text-xl text-slate-500" placeholder="Write Your Message..." ></textarea>
